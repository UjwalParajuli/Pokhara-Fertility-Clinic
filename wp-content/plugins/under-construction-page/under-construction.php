...
class UCP {
  ...
  static function tab_main() {
    ...
    if (is_plugin_active('accessibe/accessiebe.php')) {
      ...
      echo '<p>Your under construction page is currently not fully accessible for over 20% of visitors with dissabilities.<br> Make your site accessible from day one and WGAG &amp; ADA compliant by installing the <a href="#" class="open-accessibe-upsell">accessiBe plugin.</a></p>';
      echo '</td>';
      echo '</tr>';
  ...
  static function main_page() {
    ...
    echo '<li>ADA & WCAG 2.1 level AA compliance</li>';
